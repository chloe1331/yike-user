...
/* concated harmony reexport UploadBtn */__webpack_require__.d(__webpack_exports__, "j", function() { return upload_btn_UploadButton; });
...
/* concated harmony reexport TableAction */__webpack_require__.d(__webpack_exports__, "i", function() { return table_action_TableAction; });
...
/* concated harmony reexport PopoverOrderDetail */__webpack_require__.d(__webpack_exports__, "g", function() { return PopoverOrderDetail; });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_30__[/* default */ "a"])(Home, [{
    ...
    value: function handleSubmit(e) {
      ...
      if (!this.image && this.imageOpt.color == 'tran') {
        antd_lib_message__WEBPACK_IMPORTED_MODULE_26___default.a.error('请至少上传一张图片或者设置一个颜色');
              ...
              if (res.errcode == 0) {
                ...
                if (!_this9.submitOrderObj[values.order_sn]) {
                  _this9.submitOrderObj[values.order_sn] = {
                    count: 1,
                    obj: Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_24__[/* default */ "a"])({}, _this9.select.id, {
                      name: catename,
                      count: 1
                    })
                  };
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement("div", {
        ...
        onChange: function onChange(value) {
          ...
          public_utils__WEBPACK_IMPORTED_MODULE_42__[/* MServer */ "a"].get("/cate/catetextureattr/".concat(_this10.select.id)).then(function (res) {
            _this10.select.texture_attr = [];

            if (res.errcode == 0 && res.data && res.data.length) {
              _this10.select.texture_attr = res.data;
      ...
      }, react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_41__[/* UploadBtn */ "j"].Local, {
        buttonProps: {
          type: 'primary',
          icon: 'cloud-upload'
        },
      ...
      }, react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement("span", null, "\u80CC\u666F\u8272\u8BBE\u7F6E\uFF1A"), react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_41__[/* Select */ "h"], {
        style: {
          width: 120
        },
      ...
      }))), getFieldValue('type') == 10 ? react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_10___default.a.Item, null, react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_41__[/* UploadBtn */ "j"].Local, {
        ...
        label: "\u914D\u8D27\u6807\u7B7E",
        extra: getFieldValue('order_sn') ? // <a 
        //     className="text-info" 
        //     onClick={() => {
        //         this.dialogDetailRef.current && this.dialogDetailRef.current.open();
        //     }}
        // >查看订单</a>
        react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_41__[/* PopoverOrderDetail */ "g"], {
          order_sn: getFieldValue('order_sn')
        }) : null
      ...
      })(react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_41__[/* Select */ "h"], {
        options: expressList,
        fieldName: {
          value: 'id',
          label: 'name'
        ...
        content: react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(antd_lib_input__WEBPACK_IMPORTED_MODULE_8___default.a.TextArea, {
          ...
          onChange: function onChange(e) {
            return _this10.handleAddressParse(e);
          },
        ...
        columns: [{
          ...
          render: function render(text, record) {
            return react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement("span", null, text, _this10.submitOrderObj[record.order_sn] ? react__WEBPACK_IMPORTED_MODULE_35___default.a.createElement(antd_lib_tooltip__WEBPACK_IMPORTED_MODULE_14___default.a, {
