...
/* harmony import */ var public_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("HgRd");
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(Sub, [{
    ...
    value: function handleDelete(id) {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_15__[/* MServer */ "a"].post('/user/deletesub', {
        id: id
      }).then(function (res) {
        if (res.errcode == 0) {
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_17__[/* DialogCreateSub */ "b"], {
        ref: this.createRef,
        user: user,
        onSuccess: function onSuccess() {
          _this3.tableRef.current.reload();
        }
      }), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_17__[/* DialogResetPassword */ "e"], {
        ref: this.resetRef,
        resetId: resetId
      ...
      }, "\u6DFB\u52A0\u5B50\u8D26\u53F7")), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_17__[/* TableAction */ "k"], {
        action: "/user/sublist",
        ref: this.tableRef,
        columns: [{
          key: 'username',
          ...
          title: '权限',
          render: function render(text) {
            return config_constant__WEBPACK_IMPORTED_MODULE_16__[/* roleList */ "a"].find(function (item) {
          ...
          render: function render(id) {
            return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_12__["Fragment"], null, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_14___default.a, {
              href: "/sub/stat?id=".concat(id)
            }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement("a", null, "\u7EDF\u8BA1")), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(antd_lib_divider__WEBPACK_IMPORTED_MODULE_3___default.a, {
              type: "vertical"
