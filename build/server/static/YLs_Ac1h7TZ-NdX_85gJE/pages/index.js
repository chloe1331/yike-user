...
/* harmony import */ var config_locale__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__("mVpe");
/* harmony import */ var config_locale__WEBPACK_IMPORTED_MODULE_42___default = /*#__PURE__*/__webpack_require__.n(config_locale__WEBPACK_IMPORTED_MODULE_42__);
/* harmony import */ var component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__("OLV9");
/* harmony import */ var public_utils__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__("HgRd");
/* harmony import */ var public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__("5PEn");
/* harmony import */ var public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default = /*#__PURE__*/__webpack_require__.n(public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45__);
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_32__[/* default */ "a"])(Home, [{
    ...
    value: function componentDidMount() {
      ...
      this.getPart();
      this.getTextureList();
      public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].get('/upload/getToken').then(function (res) {
        if (res.errcode == 0) {
    ...
    value: function getExpress() {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].get('/logis/list', {
        is_all: 1
      }).then(function (res) {
        if (res.errcode == 0) {
          _this3.setState({
    ...
    value: function getPart() {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].get('/part/userlist', {
        is_all: 1
      }).then(function (res) {
        if (res.errcode == 0) {
          _this4.setState({
    ...
    value: function getTextureList() {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].get('/cate/texture', {
        is_all: 1,
        sort: 'asc'
      }).then(function (res) {
        if (res.errcode == 0) {
    ...
    value: function getList() {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].get('/cate/list', {
        is_all: 1
      }).then(function (res) {
        if (res.errcode == 0) {
          _this7.cateList = res.data;
          return public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].get('/cate/brand', {
            is_all: 1,
            order: 'sort'
          }).then(function (res) {
            if (res.errcode == 0) {
      ...
      validateFields(function (err, values) {
        if (!err) {
          ...
          if (isPrintEmpty) {
            ...
            formdata.append('file', Object(public_utils__WEBPACK_IMPORTED_MODULE_44__[/* convertBase64UrlToBlob */ "c"])(_this10.getResultImage(_this10.select.is_camera ? true : false)), "".concat(new Date().getTime(), ".png"));
            formdata.append('token', _this10.token);
            public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].post('//upload-z0.qiniup.com', formdata, {
              ...
              if (res.key) {
                return "".concat(config_locale__WEBPACK_IMPORTED_MODULE_42___default.a["production"].url.cdnUser).concat(res.key);
              } else {
    ...
    value: function postSubmit(params, values) {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].post('/order/save', params).then(function (res) {
        if (res.errcode == 0) {
          _this11.setState({
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* DialogOrderDetail */ "c"], {
        ref: this.dialogDetailRef,
        order_sn: getFieldValue('order_sn')
      }), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.layoutHome
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.layoutHomeBd
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.layoutHomeLeft
        ...
        onChange: function onChange(value) {
          ...
          public_utils__WEBPACK_IMPORTED_MODULE_44__[/* MServer */ "a"].get("/cate/catetextureattr/".concat(_this12.select.id)).then(function (res) {
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.layoutHomeHd
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* UploadBtn */ "i"].Local, {
        buttonProps: {
          type: 'primary',
          icon: 'cloud-upload'
        },
        ...
        ref: this.moveRef,
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.phonePreview
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.box1,
        ref: this.dragBox1
      })), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(antd_lib_tooltip__WEBPACK_IMPORTED_MODULE_14___default.a, {
        title: "\u4E0A\u4F20\u56FE\u7247\u540E\uFF0C\u62D6\u52A8\u8FDB\u884C\u65CB\u8F6C"
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.box2,
        ref: this.dragBox2
      })), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("img", {
        ref: this.uploadRef,
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.uploadImage,
        crossOrigin: "",
        src: image
      }), select ? [react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        key: "main",
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.phoneBox
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: classnames__WEBPACK_IMPORTED_MODULE_38___default()((_cx = {}, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_24__[/* default */ "a"])(_cx, public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.phoneBoxBody, true), Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_24__[/* default */ "a"])(_cx, "preview", preview || auto), _cx))
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: "bg"
      }), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.phoneBoxBodyImage
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("img", {
        ref: this.sizeImageRef,
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.phonePreviewMain,
        crossOrigin: "",
        src: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_42___default.a["production"].url.cdn).concat(select.size_img)
      }), select.camera_img ? react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("img", {
        ref: this.cameraImageRef,
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.phonePreviewCamera,
        crossOrigin: "",
        src: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_42___default.a["production"].url.cdn).concat(select.camera_img)
      }) : null), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: "bg"
      }))), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        key: "bg",
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.phoneBoxBg,
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.homeFooter
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
        className: "input-group"
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("span", null, "\u7F29\u653E\uFF1A"), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* InputNumber */ "e"], {
        ...
        className: "input-group"
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("span", null, "\u65CB\u8F6C\uFF1A"), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* InputNumber */ "e"], {
        disabled: auto,
      ...
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("span", null, "\u80CC\u666F\u8272\u8BBE\u7F6E\uFF1A"), react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* Select */ "g"], {
        style: {
          width: 120
        },
      ...
      }, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* ColorPicker */ "a"], {
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.remark
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.orderConfig
      ...
      }))), getFieldValue('type') == 10 ? react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_10___default.a.Item, null, react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* UploadBtn */ "i"].Local, {
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.remarkBox
        ...
        initialValue: 1
      })(react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* InputNumber */ "e"], {
        precision: 0,
        min: 1,
        max: 1000
      ...
      })(react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_43__[/* Select */ "g"], {
        options: expressList,
        fieldName: {
          value: 'id',
          label: 'name'
          ...
          render: function render(text, record) {
            return react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("span", null, text, _this12.submitOrderObj[record.order_sn] ? react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(antd_lib_tooltip__WEBPACK_IMPORTED_MODULE_14___default.a, {
              title: react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement("div", {
                className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_45___default.a.tooltipContent
