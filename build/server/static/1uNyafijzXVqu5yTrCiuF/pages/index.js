...
function (_Component) {
  ...
  function Index(props) {
    ...
    var handles = ['handleChangeBrand', 'handleChangeBrandType', 'handleChangeTexture', 'handleSize', 'handleRotate'];
    handles.forEach(function (item) {
    ...
    _this.canvasRef = Object(react__WEBPACK_IMPORTED_MODULE_16__["createRef"])();
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(Index, [{
    ...
    value: function getCanvas() {
      ...
      if (imageCamera && imageCamera.complete && imageBg.complete) {
        ...
        var _ctx = cameraCanvas.getContext('2d');

        cameraCanvas.setAttribute('width', width);
        cameraCanvas.setAttribute('height', height);

        _ctx.drawImage(imageCamera, 0, 0, imageCamera.width, height, _imageLeft, 0, imageBg.width, height);

        var _imageData2 = context.getImageData(_imageLeft, 0, imageBg.width, height);

        var _imageData3 = _ctx.getImageData(_imageLeft, 0, imageBg.width, imageBg.height);
    ...
    value: function getBgCanvas() {
      ...
      var drawImage = function drawImage() {
        ...
        for (var _i5 = 0; _i5 < imageDataRight.data.length; _i5 += 4) {
          imageDataRight.data[_i5] = 255;
          imageDataRight.data[_i5 + 1] = 255;
          imageDataRight.data[_i5 + 2] = 255;
          imageDataRight.data[_i5 + 3] = 127.5;
        }
        ...
        for (var _i6 = 0; _i6 < imageData.data.length; _i6 += 4) {
          if (imageData.data[_i6 + 3] == 0) {
            imageData.data[_i6] = 255;
            imageData.data[_i6 + 1] = 255;
            imageData.data[_i6 + 2] = 255;
            imageData.data[_i6 + 3] = 127.5;
          } else {
            imageData.data[_i6 + 3] = 0;
          }
        } // context.clearRect(0, 0, canvas.width, canvas.height);
        ...
        if (imageCamera && _this3.select.camera_img) {
          var drawCamera = function drawCamera() {
            ...
            for (var _i7 = 0; _i7 < imageCameraData.data.length; _i7 += 4) {
              if (imageCameraData.data[_i7] == 166) {
                imageCameraData.data[_i7] = 0;
                imageCameraData.data[_i7 + 1] = 0;
                imageCameraData.data[_i7 + 2] = 0;
                imageCameraData.data[_i7 + 3] = 255;
              }
            }
    ...
    value: function _getCanvas() {
      ...
      var _this$moveOptions2 = this.moveOptions,
          x = _this$moveOptions2.x,
          y = _this$moveOptions2.y,
          size = _this$moveOptions2.size,
          rotate = _this$moveOptions2.rotate;
    ...
    value: function listenerMove() {
      ...
      document.addEventListener('keydown', function (e) {
        if ([87, 83, 82, 65, 68, 69].includes(e.keyCode)) {
          ...
          if (e.keyCode == 69) {
            _this5.moveOptions.x = _this5.moveOptions.size + 1;
          }
    ...
    value: function handleChangeTexture(texture_id) {
      ...
      this.forceUpdate(function () {
        ...
        _this8.imageCameraRef.current.onload = function () {
          _this8.getCanvas();
        };
      });
    }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement("div", {
        ...
        onChange: function onChange(value) {
          ...
          _this9.setState({
            ...
            _this9.imageUploadRef.current.onload = function () {
              _this9.getCanvas();
        ...
        className: "hide"
      }, image ? react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement("img", {
        ref: this.imageUploadRef,
        crossOrigin: "",
        className: select ? 'hide' : '',
        src: image
      }) : null, select ? react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement("img", {
        ref: this.imageBgRef,
        crossOrigin: "",
        src: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_20___default.a["production"].url.cdn, "/").concat(select.size_img)
      }) : null, select && select.camera_img ? react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement("img", {
      ...
      }) : null), react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement("canvas", {
        ref: this.canvasRef
      }))), react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement("div", {
