...
function (_Component) {
  ...
  function Index(props) {
    ...
    var handles = ['handleSize', 'handleRotate', 'handlePreview', 'handleSubmit', 'handleAuto'];
    handles.forEach(function (item) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_23__[/* default */ "a"])(Index, [{
      ...
      validateFields(function (err, values) {
        if (!err) {
          ...
          var pl = [function () {
            ...
            formdata.append('files', Object(public_utils__WEBPACK_IMPORTED_MODULE_30__[/* convertBase64UrlToBlob */ "b"])(_this7.getResultImage()), "".concat(new Date().getTime(), ".png"));
            return public_utils__WEBPACK_IMPORTED_MODULE_30__[/* MServer */ "a"].post('/upload/userimage', formdata, {
              headers: {
            ...
            var formdata = new FormData();
            formdata.append('files', Object(public_utils__WEBPACK_IMPORTED_MODULE_30__[/* convertBase64UrlToBlob */ "b"])(_this7.getResultImage(false)), "".concat(new Date().getTime(), ".png"));
            return public_utils__WEBPACK_IMPORTED_MODULE_30__[/* MServer */ "a"].post('/upload/userimage', formdata, {
              headers: {
                'Content-Type': 'multipart/form-data'
              }
    ...
    value: function handleAuto() {
      ...
      if (!upload) {
        antd_lib_message__WEBPACK_IMPORTED_MODULE_19___default.a.error('请先上传图片');
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_28___default.a.createElement("div", {
        ...
        htmlType: "submit",
        loading: submit
      }, "\u63D0\u4EA4\u8BA2\u5355"), react__WEBPACK_IMPORTED_MODULE_28___default.a.createElement(antd_lib_button__WEBPACK_IMPORTED_MODULE_11___default.a, {
        style: {
          marginLeft: '10px'
        },
