  ...
  Object(createClass["a" /* default */])(UplaodButton, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_rc_upload_default.a, {
        ...
        action: utils["a" /* MServer */].getUrl(action || '/upload/image').fullUrl,
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement("div", {
        ...
        onChange: function onChange(value) {
          _this9.setState({
            image: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_20___default.a["production"].url.cdn).concat(value)
          }, function () {
            if (_this9.select) {
              _this9.getCanvas();
            }
        ...
        precision: 0,
        min: 1
      })), react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a.Item, null, react__WEBPACK_IMPORTED_MODULE_16___default.a.createElement(antd_lib_button__WEBPACK_IMPORTED_MODULE_1___default.a, {
        type: "primary"
      }, "\u63D0\u4EA4\u5BA1\u6838")))))));
    }
  }]);
