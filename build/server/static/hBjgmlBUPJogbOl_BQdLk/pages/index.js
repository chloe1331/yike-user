  ...
  Object(createClass["a" /* default */])(OrderList, [{
    ...
    value: function handleUpdateAddress(record) {
      ...
      this.setState({
        ...
        if (_this6.updateAddressRef.current) _this6.updateAddressRef.current.open();
      });
    }
  }, {
    key: "render",
        ...
        return [external_react_default.a.createElement("tr", {
          ...
          return external_react_default.a.createElement("tr", {
            ...
            onClick: function onClick() {
              return _this7.handleOpenImagePreview(order.image);
            }
          ...
          onConfirm: function onConfirm() {
            return _this7.handlePay(item.id);
          },
          ...
          onConfirm: function onConfirm() {
            return _this7.handleClose(item.id);
          },
          placement: "rightBottom"
        }, external_react_default.a.createElement(button_default.a, null, "\u5173\u95ED\u8BA2\u5355")), external_react_default.a.createElement(button_default.a, {
          onClick: function onClick() {
            return _this7.handleUpdateAddress(item);
          }
        }, "\u4FEE\u6539\u6536\u8D27\u4FE1\u606F"))) : null, external_react_default.a.createElement("tr", {
          key: "footer",
      ...
      validateFields(function (err, values) {
        if (!err) {
          ...
          var pl = [function () {
            ...
            formdata.append('file', Object(public_utils__WEBPACK_IMPORTED_MODULE_43__[/* convertBase64UrlToBlob */ "b"])(_this9.getResultImage()), "".concat(new Date().getTime(), ".png"));
            ...
            var formdata = new FormData();
            formdata.append('file', Object(public_utils__WEBPACK_IMPORTED_MODULE_43__[/* convertBase64UrlToBlob */ "b"])(_this9.getResultImage(false)), "".concat(new Date().getTime(), ".png"));
            formdata.append('token', _this9.token);
            return public_utils__WEBPACK_IMPORTED_MODULE_43__[/* MServer */ "a"].post('//upload-z0.qiniup.com', formdata, {
              withCredentials: false,
              headers: {
            ...
            public_utils__WEBPACK_IMPORTED_MODULE_43__[/* MServer */ "a"].post('/order/save', params).then(function (res) {
              ...
              if (res.errcode == 0) {
                ...
                antd_lib_modal__WEBPACK_IMPORTED_MODULE_26___default.a.confirm({
                  ...
                  cancelText: '查看订单',
                  onOk: function onOk() {
                    values.type == 10 && _this9.setState({
                      drawer: true
                    });
                  },
