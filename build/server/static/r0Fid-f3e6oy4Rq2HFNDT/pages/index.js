      ...
      return external_react_default.a.createElement("div", {
        ...
        return [external_react_default.a.createElement("tr", {
          ...
          return external_react_default.a.createElement("tr", {
            ...
            className: order_list_style_default.a.tableBodyRowSpan,
            rowSpan: item.orders.length
          }, item.express_name), external_react_default.a.createElement("td", {
            key: "type",
            className: order_list_style_default.a.tableBodyRowSpan,
            rowSpan: item.orders.length
          ...
          }, statusMap[item.status].text))] : null);
...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(DialogOrderDetail, [{
    ...
    value: function componentDidMount() {
      ...
      utils["a" /* MServer */].get('/order/userlist', {
        order_sn: order_sn
      }).then(function (res) {
        _this2.setState({
          list: res.errcode == 0 ? res.data : []
...
/* harmony import */ var antd_lib_tag_style__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("BucJ");
/* harmony import */ var antd_lib_tag_style__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(antd_lib_tag_style__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var antd_lib_tag__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("P7Vo");
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_35__[/* default */ "a"])(Index, [{
    ...
    value: function listenerMove() {
      ...
      var moveListener = function moveListener(e) {
        var preview = _this6.state.preview;
        if (preview) return;
        _this6.moveOptions.x = e.pageX - startPageX;
        _this6.moveOptions.y = e.pageY - startPageY;
      ...
      dom.addEventListener('mousedown', function (e) {
        startPageX = e.pageX - _this6.moveOptions.x;
        startPageY = e.pageY - _this6.moveOptions.y;
      ...
      document.addEventListener('keydown', function (e) {
        ...
        if ([87, 83, 82, 65, 68, 69].includes(e.keyCode)) {
          if (e.keyCode == 87) {
            _this6.moveOptions.y = _this6.moveOptions.y - 1;
          }
          ...
          if (e.keyCode == 65) {
            _this6.moveOptions.x = _this6.moveOptions.x - 1;
          }
          ...
          if (e.keyCode == 69) {
            _this6.sizeInputRef && _this6.sizeInputRef.setState({
              inputValue: (_this6.moveOptions.size + 0.2).toFixed(2),
              value: (_this6.moveOptions.size + 0.2).toFixed(2)
            });

            _this6.handleSize(_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_33___default()(_this6.moveOptions.size * 100 + 20) / 100, false);
          }
      ...
      if (this.dragBox1.current) {
        ...
        box.addEventListener('mousedown', function (e) {
          ...
          size = _babel_runtime_corejs2_core_js_parse_float__WEBPACK_IMPORTED_MODULE_32___default()(_this6.moveOptions.size);
      ...
      if (this.dragBox2.current) {
        ...
        var _listener = function _listener(e) {
          ...
          _this6.rotateInputRef && _this6.rotateInputRef.setState({
            inputValue: value,
            value: value
          });

          _this6.handleRotate(value);
        };
      ...
      validateFields(function (err, values) {
        if (!err) {
          ...
          var pl = [function () {
            ...
            formdata.append('file', Object(public_utils__WEBPACK_IMPORTED_MODULE_43__[/* convertBase64UrlToBlob */ "b"])(_this8.getResultImage()), "".concat(new Date().getTime(), ".png"));
            ...
            var formdata = new FormData();
            formdata.append('file', Object(public_utils__WEBPACK_IMPORTED_MODULE_43__[/* convertBase64UrlToBlob */ "b"])(_this8.getResultImage(false)), "".concat(new Date().getTime(), ".png"));
            formdata.append('token', _this8.token);
            return public_utils__WEBPACK_IMPORTED_MODULE_43__[/* MServer */ "a"].post('//upload-z0.qiniup.com', formdata, {
              withCredentials: false,
              headers: {
              ...
              if (res.errcode == 0) {
                ...
                if (!_this8.submitOrderObj[values.order_sn]) {
                  _this8.submitOrderObj[values.order_sn] = {
                    count: 1,
                    obj: Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_27__[/* default */ "a"])({}, _this8.select.id, {
                      name: catename,
                      count: 1
                    })
                  };
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement("div", {
        ...
        onChange: function onChange(value) {
          ...
          public_utils__WEBPACK_IMPORTED_MODULE_43__[/* MServer */ "a"].get("/cate/catetextureattr/".concat(_this9.select.id)).then(function (res) {
            _this9.select.texture_attr = res.errcode == 0 ? res.data : [];

            _this9.forceUpdate(function () {
              if (_this9.imageBgRef.current.complete) {
                _this9.getCanvas();
              } else {
                _this9.imageBgRef.current.onload = function () {
                  _this9.getCanvas();
                };
              }
            });
        ...
        onChange: function onChange(e) {
          return _this9.readFile(e.target.files[0]);
        }
        ...
        onClick: function onClick() {
          return _this9.handlePreview(!preview);
        }
        ...
        content: react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_14___default.a, {
          ...
          ref: function ref(e) {
            if (e) _this9.sizeInputRef = e.inputNumberRef;
          },
          onChange: function onChange(value) {
            return _this9.handleSize(value);
          },
          defaultValue: 100
          ...
          disabled: !!preview || auto,
          ref: function ref(e) {
            if (e) _this9.rotateInputRef = e.inputNumberRef;
          },
          onChange: function onChange(value) {
            return _this9.handleRotate(value);
          },
          defaultValue: 0
        }))), react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_14___default.a.Item, {
          label: "\u80CC\u666F\u8272\u8BBE\u7F6E"
        ...
        initialValue: expressList.length ? function () {
          var defaultList = expressList.files(function (item) {
            return item.default;
          });
      ...
      }, react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_6___default.a, null, "W"), "\u4E0A\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_6___default.a, null, "S"), "\u4E0B\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_6___default.a, null, "A"), "\u5DE6\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_6___default.a, null, "D"), "\u53F3\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_6___default.a, null, "E"), "\u653E\u5927"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_6___default.a, null, "R"), "\u7F29\u5C0F")), react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_drawer__WEBPACK_IMPORTED_MODULE_1___default.a, {
        title: "\u5BFC\u5165\u6DD8\u5B9D\u8BA2\u5355",
        placement: "bottom",
        height: 720,
        bodyStyle: {
        ...
        columns: [{
          ...
          render: function render(text, record) {
            return react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement("span", null, text, _this9.submitOrderObj[record.order_sn] ? react__WEBPACK_IMPORTED_MODULE_40___default.a.createElement(antd_lib_tooltip__WEBPACK_IMPORTED_MODULE_10___default.a, {
              ...
              }, _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_4___default()(_this9.submitOrderObj[record.order_sn].obj).map(function (item) {
