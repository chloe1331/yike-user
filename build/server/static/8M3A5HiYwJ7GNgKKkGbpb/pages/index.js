        ...
        if (!err) {
          ...
          _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_25___default.a.all(pl.map(function (item) {
            ...
            public_utils__WEBPACK_IMPORTED_MODULE_39__[/* MServer */ "a"].post('/order/save', params).then(function (res) {
              ...
              if (res.errcode == 0) {
                if (values.type == 10) _this7.submitOrderIds.push(selectedRow.index);
    ...
    value: function render() {
      ...
      var rowSelection = {
        ...
        getCheckboxProps: function getCheckboxProps(record) {
          return {
            disabled: _this8.submitOrderIds.includes(record.index)
          };
        }
      };
      return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement("div", {
        ...
        columns: [{
          ...
          render: function render(text, record) {
            return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement("span", null, text, _this8.submitOrderIds.includes(record.index) ? react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement("span", {
              className: "text-success"
            }, "(\u5DF2\u63D0\u4EA4)") : null);
          }
        }, {
