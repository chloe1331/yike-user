...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_32__[/* default */ "a"])(Home, [{
      ...
      validateFields(function (err, values) {
        if (!err) {
          ...
          var params = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_29__[/* default */ "a"])({
            type: values.type == 20 || !_this10.select ? 10 : values.type,
            order_sn: values.order_sn,
            quantity: values.quantity,
            cate_id: _this10.select && _this10.select.id
          }, options);
          ...
          if (isPrintEmpty) {
            ...
            formdata.append('file', Object(public_utils__WEBPACK_IMPORTED_MODULE_45__[/* convertBase64UrlToBlob */ "b"])(_this10.getResultImage(_this10.select.is_camera ? true : false)), "".concat(new Date().getTime(), ".png"));
    ...
    value: function render() {
      ...
      })(react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(antd_lib_input__WEBPACK_IMPORTED_MODULE_8___default.a, null))))) : null, [10, 20].includes(getFieldValue('type')) && partList.length ? react__WEBPACK_IMPORTED_MODULE_37___default.a.createElement(antd_lib_table__WEBPACK_IMPORTED_MODULE_4___default.a, {
        rowKey: "id",
        dataSource: partList,
        pagination: false,
