...
/* concated harmony reexport TableAction */__webpack_require__.d(__webpack_exports__, "d", function() { return table_action_TableAction; });
...
/* harmony import */ var _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("6BQ9");
...
/* harmony import */ var component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__("OLV9");
/* harmony import */ var public_utils__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__("HgRd");
/* harmony import */ var public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__("5PEn");
/* harmony import */ var public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23__);
/* harmony import */ var config_locale__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__("mVpe");
/* harmony import */ var config_locale__WEBPACK_IMPORTED_MODULE_24___default = /*#__PURE__*/__webpack_require__.n(config_locale__WEBPACK_IMPORTED_MODULE_24__);
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_19__[/* default */ "a"])(Index, _Component);

  function Index(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(this, Index);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_16__[/* default */ "a"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_17__[/* default */ "a"])(Index).call(this, props));
    _this.state = {
      brands: [],
      brandTypes: [],
      cates: [],
    ...
    _this.transBgRef = Object(react__WEBPACK_IMPORTED_MODULE_20__["createRef"])();
    _this.imageUploadRef = Object(react__WEBPACK_IMPORTED_MODULE_20__["createRef"])();
    _this.imageBgRef = Object(react__WEBPACK_IMPORTED_MODULE_20__["createRef"])();
    _this.imageCameraRef = Object(react__WEBPACK_IMPORTED_MODULE_20__["createRef"])();
    _this.canvasRef = Object(react__WEBPACK_IMPORTED_MODULE_20__["createRef"])();
    _this.canvasCameraRef = Object(react__WEBPACK_IMPORTED_MODULE_20__["createRef"])();
    _this.boxRef = Object(react__WEBPACK_IMPORTED_MODULE_20__["createRef"])();
    _this.previewDialogRef = Object(react__WEBPACK_IMPORTED_MODULE_20__["createRef"])();
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(Index, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.getBrands();
      this.getCanvas();
    ...
    value: function getBrands() {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_22__[/* MServer */ "a"].get('/cate/brand', {
        is_all: 1
      }).then(function (res) {
        if (res.errcode == 0) {
          _this2.setState({
    ...
    value: function getCanvas() {
      ...
      var height = bg && bg.complete ? _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_13___default()(bg.height * ratio) : boxHeight;
    ...
    value: function getCameraCanvas() {
      ...
      var height = camera && camera.complete ? _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_13___default()(camera.height * ratio) : boxHeight;
      canvas.setAttribute('width', canvasWidth);
      canvas.setAttribute('height', height);
    ...
    value: function getPreviewImage() {
      ...
      var height = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_13___default()(camera.height * ratio);
    ...
    value: function listenerMove() {
      ...
      var moveListener = function moveListener(e) {
        var preview = _this4.state.preview;
        if (preview) return;
        _this4.moveOptions.x = e.pageX - startPageX;
        _this4.moveOptions.y = e.pageY - startPageY;
      ...
      dom.addEventListener('mousedown', function (e) {
        startPageX = e.pageX - _this4.moveOptions.x;
        startPageY = e.pageY - _this4.moveOptions.y;
      ...
      document.addEventListener('keydown', function (e) {
        ...
        if ([87, 83, 82, 65, 68, 69].includes(e.keyCode)) {
          if (e.keyCode == 87) {
            _this4.moveOptions.y = _this4.moveOptions.y - 1;
          }
          ...
          if (e.keyCode == 65) {
            _this4.moveOptions.x = _this4.moveOptions.x - 1;
          }
          ...
          if (e.keyCode == 69) {
            _this4.moveOptions.size = _this4.moveOptions.size + 0.2 / 100;
    ...
    value: function handleChangeBrand(brand_id) {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_22__[/* MServer */ "a"].get('/cate/brandType', {
        brand_id: brand_id,
        is_all: 1
      }).then(function (res) {
        _this5.condition.brand_id = brand_id;

        if (res.errcode == 0) {
          _this5.condition.texture_id = undefined;
          _this5.condition.brand_type_id = undefined;
          _this5.select = null;
        }
    ...
    value: function handleChangeBrandType(brand_type_id) {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_22__[/* MServer */ "a"].get('/cate/brandTypeTexture', {
    ...
    value: function handleChangeTexture(texture_id) {
      ...
      this.forceUpdate(function () {
        _this7.imageBgRef.current.onload = function () {
          _this7.getCanvas();
        };
      });
    }
    ...
    value: function handleSubmit(e) {
      ...
      validateFields(function (err, values) {
        if (!err) {
          ...
          public_utils__WEBPACK_IMPORTED_MODULE_22__[/* MServer */ "a"].post('/order/save', Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])({}, values, {
            cate_id: _this9.select.id,
            image: _this9.getResultImage(),
            image1: _this9.getResultImage(false)
          })).then(function (res) {
            _this9.setState({
              submit: false
            });
    ...
    value: function handleAuto() {
      ...
      if (!upload) {
        antd_lib_message__WEBPACK_IMPORTED_MODULE_12___default.a.error('请先上传图片');
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("div", {
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default.a.layoutHome
      }, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default.a.layoutHomeHd
      }, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_21__[/* Select */ "c"], {
        options: brands,
        fieldName: {
          label: 'name',
          value: 'id'
      ...
      }, "\u4E0A\u4F20\u56FE\u7247")), react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default.a.layoutHomeBd
      }, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default.a.mobilePreview
      }, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default.a.mobilePreviewCanvas,
        ref: this.boxRef
      }, preview ? react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default.a.previewImage
      ...
      }), image ? react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("img", {
        ref: this.imageUploadRef,
        crossOrigin: "",
        src: image
      }) : null, select ? react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("img", {
        ref: this.imageBgRef,
        crossOrigin: "",
        src: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_24___default.a["production"].url.cdn, "/").concat(select.size_img)
      }) : null, select && select.camera_img ? react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("img", {
        ref: this.imageCameraRef,
        crossOrigin: "",
        src: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_24___default.a["production"].url.cdn, "/").concat(select.camera_img)
      }) : null), react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("canvas", {
        key: "canvas1",
        ref: this.canvasRef
      }), react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("canvas", {
        key: "canvas2",
        ref: this.canvasCameraRef
      }))), react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default.a.orderConfig
      }, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_3___default.a, {
        className: "inline-form ".concat(public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_23___default.a.sizeForm)
      }, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_3___default.a.Item, {
        label: "\u7F29\u653E"
      ...
      })), react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_3___default.a.Item, null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_button__WEBPACK_IMPORTED_MODULE_7___default.a, {
        disabled: !!preview,
        type: "dashed",
        onClick: this.handleAuto
      }, "\u56FE\u7247\u81EA\u9002\u5E94")), react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_3___default.a.Item, null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_1___default.a, null, "W"), "\u4E0A\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_1___default.a, null, "S"), "\u4E0B\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_1___default.a, null, "A"), "\u5DE6\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_1___default.a, null, "D"), "\u53F3\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_1___default.a, null, "E"), "\u653E\u5927"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_1___default.a, null, "R"), "\u7F29\u5C0F"))), react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_3___default.a, {
        ...
        precision: 0,
        min: 1
      }))), select && select.texture_attr.length ? react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_3___default.a.Item, {
        label: "\u5C5E\u6027(\u989C\u8272)"
      ...
      }))) : null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_3___default.a.Item, null, react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_button__WEBPACK_IMPORTED_MODULE_7___default.a, {
        type: "primary",
        htmlType: "submit",
        loading: submit
      }, "\u63D0\u4EA4\u8BA2\u5355"), react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement(antd_lib_button__WEBPACK_IMPORTED_MODULE_7___default.a, {
        style: {
          marginLeft: '10px'
        },
