...
/* concated harmony reexport UploadBtn */__webpack_require__.d(__webpack_exports__, "d", function() { return upload_btn_UplaodButton; });
...
/* harmony import */ var antd_lib_message_style__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("XZ83");
...
/* harmony import */ var public_utils__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__("HgRd");
/* harmony import */ var public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__("5PEn");
/* harmony import */ var public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21___default = /*#__PURE__*/__webpack_require__.n(public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21__);
/* harmony import */ var config_locale__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__("mVpe");
/* harmony import */ var config_locale__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(config_locale__WEBPACK_IMPORTED_MODULE_22__);
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_17__[/* default */ "a"])(Index, _Component);

  function Index(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(this, Index);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(Index).call(this, props));
    _this.state = {
      brands: [],
      brandTypes: [],
      cates: [],
    ...
    var handles = ['handleChangeBrand', 'handleChangeBrandType', 'handleChangeTexture', 'handleSize', 'handleRotate', 'handlePreview'];
    handles.forEach(function (item) {
      return _this[item] = _this[item].bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_16__[/* default */ "a"])(_this));
    });
    _this.condition = {
      brand_id: undefined,
    ...
    _this.imageUploadRef = Object(react__WEBPACK_IMPORTED_MODULE_18__["createRef"])();
    _this.imageBgRef = Object(react__WEBPACK_IMPORTED_MODULE_18__["createRef"])();
    _this.imageCameraRef = Object(react__WEBPACK_IMPORTED_MODULE_18__["createRef"])();
    _this.canvasRef = Object(react__WEBPACK_IMPORTED_MODULE_18__["createRef"])();
    _this.boxRef = Object(react__WEBPACK_IMPORTED_MODULE_18__["createRef"])();
    _this.previewDialogRef = Object(react__WEBPACK_IMPORTED_MODULE_18__["createRef"])();
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(Index, [{
    ...
    value: function getBrands() {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_20__[/* MServer */ "a"].get('/cate/brand', {
        is_all: 1
      }).then(function (res) {
        if (res.errcode == 0) {
          _this2.setState({
    ...
    value: function getCanvas() {
      ...
      if (imageCamera && imageCamera.complete && imageBg.complete) {
        var _imageLeft = width / 2 - imageBg.width / 2;

        var cameraCanvas = document.createElement('canvas');

        var _ctx2 = cameraCanvas.getContext('2d');

        cameraCanvas.setAttribute('width', width);
        cameraCanvas.setAttribute('height', height);

        _ctx2.drawImage(imageCamera, 0, 0, imageCamera.width, height, _imageLeft, 0, imageBg.width, height);

        var _imageData2 = context.getImageData(_imageLeft, 0, imageBg.width, height);

        var _imageData3 = _ctx2.getImageData(_imageLeft, 0, imageBg.width, imageBg.height);

        for (var _i4 = 0; _i4 < _imageData3.data.length; _i4 += 4) {
          if (_imageData3.data[_i4 + 3] == 255) {
            _imageData2.data[_i4] = 0;
            _imageData2.data[_i4 + 1] = 0;
            _imageData2.data[_i4 + 2] = 0;
            _imageData2.data[_i4 + 3] = 255;
          }
        }

        context.putImageData(_imageData2, _imageLeft, 0);
      }
    }
  }, {
    key: "listenerMove",
    value: function listenerMove() {
      ...
      document.addEventListener('keydown', function (e) {
        if ([87, 83, 82, 65, 68, 69].includes(e.keyCode)) {
          ...
          if (e.keyCode == 69) {
            _this3.moveOptions.x = _this3.moveOptions.size + 1;
          }
    ...
    value: function handleChangeBrand(brand_id) {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_20__[/* MServer */ "a"].get('/cate/brandType', {
        brand_id: brand_id,
        is_all: 1
      }).then(function (res) {
    ...
    value: function handleChangeBrandType(brand_type_id) {
      ...
      public_utils__WEBPACK_IMPORTED_MODULE_20__[/* MServer */ "a"].get('/cate/brandTypeTexture', {
    ...
    value: function handleChangeTexture(texture_id) {
      ...
      this.forceUpdate(function () {
        ...
        _this6.imageCameraRef.current.onload = function () {
          _this6.getCanvas();
        };
      });
    }
    ...
    value: function handlePreview() {
      ...
      if (!this.select) {
        antd_lib_message__WEBPACK_IMPORTED_MODULE_11___default.a.error('请先选择机型');

        return;
      }

      if (!this.state.image) {
        antd_lib_message__WEBPACK_IMPORTED_MODULE_11___default.a.error('请先上传定制图片');
      ...
      if (imageCamera) {
        ...
        for (var _i5 = 0; _i5 < imageDataCamera.data.length; _i5 += 4) {
          if (imageDataCamera.data[_i5 + 3] != 0) {
            imageData.data[_i5 + 3] = 0;
          }
        }
      }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("div", {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_19__[/* DialogImagePreview */ "a"], {
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21___default.a.layoutHome
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21___default.a.layoutHomeHd
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_19__[/* Select */ "c"], {
        options: brands,
        fieldName: {
          label: 'name',
          value: 'id'
      ...
      }), react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_19__[/* UploadBtn */ "d"], {
        buttonProps: {
          type: 'primary'
        },
        buttonText: "\u4E0A\u4F20\u56FE\u7247",
        ...
        onChange: function onChange(value) {
          _this8.moveOptions.size = undefined;
          _this8.moveOptions.y = undefined;

          _this8.setState({
            image: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_22___default.a["production"].url.cdnUser).concat(value)
          }, function () {
            _this8.imageUploadRef.current.onload = function () {
              _this8.getCanvas();
        ...
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21___default.a.layoutHomeBd
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21___default.a.mobilePreview
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21___default.a.mobilePreviewCanvas,
        ref: this.boxRef
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("div", {
        className: "hide"
      }, image ? react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("img", {
        ref: this.imageUploadRef,
        crossOrigin: "",
        className: select ? 'hide' : '',
        src: image
      }) : null, select ? react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("img", {
        ref: this.imageBgRef,
        crossOrigin: "",
        src: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_22___default.a["production"].url.cdn, "/").concat(select.size_img)
      }) : null, select && select.camera_img ? react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("img", {
        ref: this.imageCameraRef,
        crossOrigin: "",
        src: "".concat(config_locale__WEBPACK_IMPORTED_MODULE_22___default.a["production"].url.cdn, "/").concat(select.camera_img)
      }) : null), react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("canvas", {
        ref: this.canvasRef
      }))), react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("div", {
        className: public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21___default.a.orderConfig
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a, {
        className: "inline-form ".concat(public_theme_pages_index_less__WEBPACK_IMPORTED_MODULE_21___default.a.sizeForm)
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a.Item, {
        label: "\u7F29\u653E"
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_input_number__WEBPACK_IMPORTED_MODULE_9___default.a, {
        precision: 2,
      ...
      })), react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a.Item, null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_5___default.a, null, "W"), "\u4E0A\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_5___default.a, null, "S"), "\u4E0B\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_5___default.a, null, "A"), "\u5DE6\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_5___default.a, null, "D"), "\u53F3\u79FB"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_5___default.a, null, "E"), "\u653E\u5927"), "\uFF0C", react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement("span", null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_tag__WEBPACK_IMPORTED_MODULE_5___default.a, null, "R"), "\u7F29\u5C0F"))), react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a, null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a.Item, {
        label: "\u914D\u8D27\u6807\u7B7E"
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_input__WEBPACK_IMPORTED_MODULE_3___default.a, null)), react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a.Item, {
        label: "\u8BA2\u8D27\u6570\u91CF"
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_input_number__WEBPACK_IMPORTED_MODULE_9___default.a, {
        precision: 0,
        min: 1
      })), select && select.texture_attr.length ? react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a.Item, {
        label: "\u5C5E\u6027(\u989C\u8272)"
      }, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(component__WEBPACK_IMPORTED_MODULE_19__[/* Select */ "c"], {
      ...
      })) : null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_form__WEBPACK_IMPORTED_MODULE_7___default.a.Item, null, react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_button__WEBPACK_IMPORTED_MODULE_1___default.a, {
        type: "primary"
      }, "\u63D0\u4EA4\u5BA1\u6838"), react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(antd_lib_button__WEBPACK_IMPORTED_MODULE_1___default.a, {
        style: {
          marginLeft: '10px'
        },
